...
var image = ee.Algorithms.Landsat.simpleComposite({
  collection:l8raw.filterDate('2014-01-01', '2014-02-28'),
  asFloat:true
...
// Create variables for training data
...
//0= water; 1 = Green urban Infrastructure (GUI); 2 = built-up areas 3= Bare ground 
...
var DATE_RANGE = ee.Filter.dayOfYear(1, 59);
var YEAR_RANGE = ee.Filter.calendarRange(2014, 2014,'year');
...
var LC08_bands = ['B10', 'QA_PIXEL']; // Landsat 8 surface temperature (ST) & QA_Pixel bands
...
var filtered_L8 = L8.filter(ee.Filter.lt('CLOUD_COVER', 10));
